...
> this file in sync with `activation/claude-code/simon-persona.md` until the
...
1. Check for local context at `.claude/context/industry-context.md`. (This
   path is shared across Claude Code and Cursor activations so domain context
